...
import type { ChatRequest, BackgroundMessage, ApplyPlanRequest } from '@shared/types/messaging'
import type { ChatMessage } from '@shared/types/chat'
import { runGraph } from '@ai/orchestrator'
import { getOpenAiKey, getN8nApiKey, getBaseUrlOrDefault } from '@platform/settings'
